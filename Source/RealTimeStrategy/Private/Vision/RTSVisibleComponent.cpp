...
{
	const ERTSVisionState VisionState = GetVisionStateForPlayer(Controller);
	...
	const URTSOwnerComponent* OwnerComponent = GetOwner()->FindComponentByClass<URTSOwnerComponent>();
